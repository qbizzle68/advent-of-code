...
#    for instruction, from_coords, to_coords in lights:
 #       x0, y0 = from_coords
  #      x1, y1 = to_coords
...
def count_lights(lights: list[list[bool]]) -> int:
    count = 0
    for i in range(1000):
        for j in range(1000):
            if lights[i][j]:
